...
class SCA_Blocak(nn.Module):
    def __init__(self, inchannel=256, h=32, w=32):
...
class TransRoadNet(nn.Module):
    def __init__(self, *, hidden_dim=64, layers=(2,2,6,2), heads=(3,6,12,24), channels=3, num_classes=1, head_dim=32, window_size=8,
