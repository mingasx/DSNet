...
from net.MSMDFF.networks.A11_MSMDFFNet.init_block.multi_D_initblock import initblock_plus4
from net.MSMDFF.networks.A11_MSMDFFNet.encoder.MSENCODER import encoder_i,connecter,nonlinearity
from net.MSMDFF.networks.A11_MSMDFFNet.model.decoder import DecoderBlock_v4fix as F_DecoderBlock_v4fix
...
class MSMDFF_Net_v3_plus(nn.Module):
    ...
    def forward(self, x):
        ...
        e4 = self.encoder4(x, e3)  # 1024*32*32
...
if __name__ == '__main__':
    ...
    # 现在运行模型概述和计算FLOPs
    summary(model, input_size=(3, 512, 512), device='cuda' if torch.cuda.is_available() else 'cpu')
